...
from .model import GPTConfig , GPT1Config , CausalSelfAttention , Block

logger = logging.getLogger(__name__)

class GPTG(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.graph_emb = nn.Linear(config.n_components, config.n_embd)
    ...
    def forward(self, in_tup , targets=None):
        idx = in_tup[0]
        node_embed = in_tup[1]
        b, t = idx.size()
